...
var ValidationField = function (_RefluxComponent) {
    ...
    function ValidationField(props) {
        ...
        _this.renderError = function () {
            return Responsive.isTablet() ? _this.state.error ? React.createElement('div', { className: 'validation-field__error-message', dangerouslySetInnerHTML: { __html: _this.state.error } }) : null : React.createElement(
                Tooltip,
