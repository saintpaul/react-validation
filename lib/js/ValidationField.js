...
var ValidationField = function (_RefluxComponent) {
    ...
    function ValidationField(props) {
        ...
        _this.showIcons = function () {
            return _this.props.showIcons && !_this.isSelect() && !_this.isCheckbox();
        };
        ...
        _this.className = function () {
            return classnames("validation-field", _this.props.className, {
                ...
                "validation-field--with-label": _this.showLabel(), // Hide icon by default field is a Select / checkbox
        ...
        _this.renderCharsLeft = function () {
            ...
            var charsLeft = count >= _this.getRule("max") ? 0 : _this.getRule("max") - count;
        ...
        _this.renderInputWithLabel = function (input) {
            return React.createElement(
                'label',
                { className: 'validation-field__label' },
                React.createElement('div', { dangerouslySetInnerHTML: { __html: _this.props.label }, className: 'validation-field__label-title' }),
                input
            );
        };
        ...
        _this.render = function () {
            ...
            if (_this.showCharsLeft() && _.isUndefined(_this.getRule("max"))) console.error('ValidationField with name \'' + _this.props.name + '\' should declare \'max\' rule because \'showCharsLeft\' is defined');
            ...
            { inputProps: _.merge(_this.getInput().props.inputProps, { onBlur: _this.onBlur }) } : { onBlur: _this.onBlur } : {};
            ...
            return React.createElement(
                'div',
                _extends({ className: _this.className() }, tooltipProps),
