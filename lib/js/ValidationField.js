...
var ValidationField = function (_RefluxComponent) {
    ...
    function ValidationField(props) {
        ...
        _this.isSelect = function () {
            return _this.getInput().type.name === SPECIAL_CHILD.CUSTOM_SELECT || _this.getInput().type.name === SPECIAL_CHILD.SELECT;
        };

        _this.isDatePicker = function () {
            return _this.getInput().type.name === SPECIAL_CHILD.CUSTOM_DATEPICKER;
        };

        _this.isCheckbox = function () {
            return _this.getInput().props.type === SPECIAL_CHILD.CHECKBOX;
        };
        ...
        _this.className = function () {
            return classnames("validation-field", {
                "validation-field--error": _this.state.error,
                "validation-field--success": _this.state.isValid,
                "validation-field--no-icons": !_this.props.showIcons || _this.isSelect() || _this.isCheckbox(), // Hide icon by default field is a Select / checkbox
        ...
        _this.renderTooltip = function () {
            return _this.state.error ? React.createElement(Tooltip, { ref: _this.props.name, id: _this.props.name, effect: 'solid', 'class': 'validation-tooltip', html: true }) : null;
        };
        ...
        _this.render = function () {
            if (!_this.getInput() || _.isArray(_this.getInput())) {
            ...
            var newProps = _.merge({ onChange: _this.onChange, id: _this.props.name }, _this.props.triggerOnBlur ? { onBlur: _this.onBlur } : {});
            ...
            var tooltipDisplayEvents = 'mouseenter touchstart';
            var tooltipCloseEvents = "mouseleave";

            // TODO RCH : bug on mobile : focus on input text make the tooltip disappear
            return React.createElement(
                'div',
                { className: _this.className(), 'data-for': _this.props.name, 'data-tip': _this.state.error, 'data-event': tooltipDisplayEvents, 'data-event-off': tooltipCloseEvents },
                _this.renderTooltip(),
