    ...
    function ValidationField(props) {
        ...
        _this.className = function () {
            return classnames("validation-field", {
                ...
                "validation-field--with-icons": _this.props.showIcons && !_this.isSelect() && !_this.isCheckbox(), // Hide icon by default field is a Select / checkbox
        ...
        _this.render = function () {
            ...
            return React.createElement(
                'div',
                { className: _this.className(), 'data-for': _this.props.name, 'data-tip': '', 'data-event': tooltipDisplayEvents, 'data-event-off': tooltipCloseEvents },
                _this.renderTooltip(),
