...
var ValidationField = function (_RefluxComponent) {
    ...
    function ValidationField(props) {
        ...
        _this.renderTooltip = function () {
            return _this.state.error ? React.createElement(
                Tooltip,
                { id: _this.props.name, effect: 'solid', 'class': 'validation-tooltip', html: true },
                _this.state.error
            ) : null;
        };
        ...
        _this.render = function () {
            ...
            return React.createElement(
                'div',
                { className: _this.className(), 'data-for': _this.props.name, 'data-tip': true, 'data-event': tooltipDisplayEvents, 'data-event-off': tooltipCloseEvents },
                _this.renderTooltip(),
