...
var RefluxListener = require('./utils/RefluxListener');
...
var ValidationField = function (_aggregation) {
    _inherits(ValidationField, _aggregation);

    function ValidationField(props) {
        _classCallCheck(this, ValidationField);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ValidationField).call(this, props));
        ...
        _this._onChange = function (e) {
            var inputEvent = arguments.length <= 1 || arguments[1] === undefined ? function () {} : arguments[1];
        ...
        _this.onBlur = function (e) {
            return _this._onChange(e, _this.getInputOnBlur());
        };
        ...
        _this.convertValue = function (inputValue) {
            ...
            if (_this.rulesIsArray()) {
                if (_.find(_this.props.rules, function (rule) {
                    return rule.type === "integer";
                })) convertedValue = ValidationUtils.toInteger(inputValue);else if (_.find(_this.props.rules, function (rule) {
                    return rule.type === "float" || rule.type === "number";
                })) convertedValue = ValidationUtils.toFloat(inputValue);else if (_.find(_this.props.rules, function (rule) {
                    return rule.type === "string";
                })) convertedValue = ValidationUtils.toString(inputValue);else if (_.find(_this.props.rules, function (rule) {
                    return rule.type === "boolean";
                })) convertedValue = ValidationUtils.toBoolean(inputValue);
            } else {
                if (_this.props.rules.type === "integer") convertedValue = ValidationUtils.toInteger(inputValue);else if (_this.props.rules.type === "float" || _this.props.rules.type === "number") convertedValue = ValidationUtils.toFloat(inputValue);else if (_this.props.rules.type === "string") convertedValue = ValidationUtils.toString(inputValue);else if (_this.props.rules.type === "boolean") convertedValue = ValidationUtils.toBoolean(inputValue);
            }
        ...
        _this.convertSpecialCases = function (inputValue) {
            ...
            if (_this.rulesIsArray()) {
                ...
                }) && _.isEmpty(inputValue) || _.find(_this.props.rules, function (rule) {
                    return rule.type === "object";
                }) && _.isEmpty(inputValue)) convertedValue = undefined;
            } else {
                if (_this.props.rules.type === "array" && _.isEmpty(inputValue) || _this.props.rules.type === "object" && _.isEmpty(inputValue)) convertedValue = undefined;
            }
            return convertedValue;
        };
        ...
        _this.render = function () {
            ...
            var newProps = _.merge({ onChange: _this.onChange }, _this.props.onBlur ? { onBlur: _this.onBlur } : {}, _this.state.error ? { bsStyle: "error" } : {});
            ...
            return React.createElement(
                "div",
                { className: classnames({ "has-error": _this.state.error }) },
                _this.props.label ? inputWithLabel : input,
                _this.state.error ? React.createElement(
                    "div",
                    { className: "validation-field-error" },
                    _this.state.error
                ) : null
            );
        };
    ...
    _createClass(ValidationField, [{
        ...
        value: function componentWillUnmount() {
            ...
            _get(Object.getPrototypeOf(ValidationField.prototype), "componentWillUnmount", this).call(this);
