...
function (_RefluxComponent) {
  ...
  function ValidationField(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderError", function () {
      ...
      }, _this.state.error) : null : React.createElement(Tooltip, {
        id: _this.props.name,
        effect: "solid",
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      }, tooltipProps), input, _this.showIcons() ? _this.renderIcon() : null), _this.showCharsLeft() ? _this.renderCharsLeft() : null, _this.renderError());
    });
