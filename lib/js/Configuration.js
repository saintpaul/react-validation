...
var Configuration = {
  ...
  COUNT_MESSAGE: function COUNT_MESSAGE(count) {
    return "".concat(count, " character(s) remaining");
  },
  ...
  MESSAGES: Messages,
  // Takes by default async-validate messages. A full object can be passed or some properties can be overrided manually
