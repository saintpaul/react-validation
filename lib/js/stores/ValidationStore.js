...
var ValidationStore = function (_Reflux$Store) {
    _inherits(ValidationStore, _Reflux$Store);

    function ValidationStore() {
        _classCallCheck(this, ValidationStore);

        var _this = _possibleConstructorReturn(this, (ValidationStore.__proto__ || Object.getPrototypeOf(ValidationStore)).call(this));

        _this.addField = function (name, rules, group) {
            ...
            if (_this.fields[name]) {
                ...
                _this.fields[name] = { rules: rules, group: group };
            }
        };
        ...
        _this.validateAllFields = function (group) {
            _this.validateAll = {
                enabled: true,
                fields: {},
                errors: [],
        ...
        _this._getSchema = function (fieldName) {
            return new Schema({
                type: "object",
        ...
        _this._getValidateOptions = function () {
            return {
        ...
        _this._getGroupFields = function (group) {
        ...
        _this._validateField = function (name, error) {
