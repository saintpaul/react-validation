...
var ValidationSubmit = function (_aggregation) {
    _inherits(ValidationSubmit, _aggregation);
    ...
    function ValidationSubmit(props) {
        ...
        _this.render = function () {
            return React.createElement('button', _extends({}, _this.props, { onClick: _this.submit }));
        };
