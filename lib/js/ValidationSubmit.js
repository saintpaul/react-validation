...
var ValidationSubmit = function (_RefluxComponent) {
    ...
    function ValidationSubmit(props) {
        ...
        _this.render = function () {
            var newProps = _.merge(_this._cleanProps(), { onClick: _this.submit });

            return _this.props.renderFactory ? _this.props.renderFactory(newProps) : React.createElement("button", _extends({}, newProps, { onClick: _this.submit }));
        };
